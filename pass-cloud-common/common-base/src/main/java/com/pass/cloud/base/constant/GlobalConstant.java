package com.pass.cloud.base.constant;
...
public class GlobalConstant {
    ...
    public static final String ROOT_PREFIX = "passcloud";

    public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
    public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

    public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/passcloud/registry/service";
    public static final String ZK_REGISTRY_ID_ROOT_PATH = "/passcloud/registry/id";
    public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/passcloud/registry/producer";
    public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/passcloud/registry/consumer";
    public static final String ZK_REGISTRY_SEQ = "/passcloud/seq";
    ...
    public static final class Sys {
         ...
         */
        public static final String DEFAULT_FILE_PATH = "passcloud/file/";
     ...
     * The class Symbol.
     *
     * @author passcloud.net@gmail.com
     */
