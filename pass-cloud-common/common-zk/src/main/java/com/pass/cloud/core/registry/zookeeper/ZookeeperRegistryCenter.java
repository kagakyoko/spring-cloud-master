package com.pass.cloud.core.registry.zookeeper;
...
import com.pass.cloud.core.registry.base.ReliableMessageRegisterDto;
import com.pass.cloud.core.registry.exception.RegExceptionHandler;
...
public class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
     ...
     */
    @Override
    public void registerMq(final String app, final String host, final String producerGroup, final String consumerGroup, String nameSrvAddress) {
        // 注册生产者
        ...
        if (StringUtils.isNotEmpty(producerGroup)) {
            dto = new ReliableMessageRegisterDto().setProducerGroup(producerGroup).setNameSrvAddress(nameSrvAddress);
        ...
        if (StringUtils.isNotEmpty(consumerGroup)) {
            dto = new ReliableMessageRegisterDto().setConsumerGroup(consumerGroup).setNameSrvAddress(nameSrvAddress);
            String producerJson = JSON.toJSONString(dto);
