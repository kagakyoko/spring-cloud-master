package com.pass.cloud.security.feign;

import com.pass.cloud.security.feign.interceptor.OAuth2FeignRequestInterceptor;
import com.pass.cloud.security.feign.interceptor.Oauth2FeignErrorInterceptor;
import com.pass.cloud.security.feign.properties.Oauth2ClientProperties;
import feign.Logger;
...
public class OAuth2FeignAutoConfiguration {
     ...
     */
    @Bean("passcloudClientCredentialsResourceDetails")
     ...
     */
    @Bean
    public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("passcloudOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
