...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "passcloud:restPwd";
    private static final String ACTIVE_USER = "passcloud:activeUser";
    private static final String SEND_SMS_COUNT = "passcloud:sms:count";
    private static final String SEND_EMAIL_CODE = "passcloud:email:code";
    private static final String ACCESS_TOKEN = "passcloud:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "passcloud:file:upload_file_size";
