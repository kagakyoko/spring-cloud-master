...
import com.pass.cloud.common.annotation.Required;
...
public class BeanUtils {
     ...
     */
    public static void checkRequiredFields(Object bean) throws HttpErrorException {
        ...
        if (!requiredFields.isEmpty()) {
            ...
            log.debug(msg);
            throw new HttpErrorException(HttpError.builder().errorMsg(msg).build());
        }
    }
